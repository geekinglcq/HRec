# -*- coding:utf-8 -*-
# ###########################
# File Name: xdeepfm.py
# Author: geekinglcq
# Mail: lcqgeek@live.com
# Created Time: 2020-12-31 17:31:23
# ###########################
r"""
xDeepFM
################################################
...
from .layers import MLPLayers, activation_layer
from .base import ContextModel


class xDeepFM(ContextModel):
    ...
    def __init__(self, config, dataset):
        ...
        self.eize = temp_cin_size = list(config['cin_layer_size'])
    ...
    def forward(self, interaction):
        ...
        cin_output = self.compressed_interaction_network(sparse_embedding)
